...
-   [Defaults files](#defaults-files)
    ...
    -   [Reader options](#reader-options-1)
    -   [General writer options](#general-writer-options-1)
    -   [Options affecting specific
        writers](#options-affecting-specific-writers-1)
    -   [Citation rendering](#citation-rendering-1)
    -   [Math rendering in HTML](#math-rendering-in-html-1)
    -   [Options for wrapper scripts](#options-for-wrapper-scripts-1)
-   [Templates](#templates)
...
-   [Slide shows](#slide-shows)
    ...
    -   [Columns](#columns)
        -   [Additional columns attributes in
            beamer](#additional-columns-attributes-in-beamer)
    -   [Frame attributes in beamer](#frame-attributes-in-beamer)
    -   [Background in reveal.js, beamer, and
        pptx](#background-in-reveal.js-beamer-and-pptx)
        -   [On all slides (beamer, reveal.js,
            pptx)](#on-all-slides-beamer-reveal.js-pptx)
        -   [On individual slides (reveal.js,
            pptx)](#on-individual-slides-reveal.js-pptx)
        -   [On the title slide (reveal.js,
            pptx)](#on-the-title-slide-reveal.js-pptx)
...
below](#general-options-1). Pandoc can also produce
...
for [citation rendering](#citation-rendering-1). The following packages
...
:   Use the specified engine when producing PDF output. Valid values are
    ...
    `wkhtmltopdf`, `weasyprint`, `pagedjs-cli`, `prince`, `context`, and
    `pdfroff`. If the engine is not in your PATH, the full path of the
    engine may be specified here. If this option is not specified,
    pandoc uses the following defaults depending on the output format
    specified using `-t/--to`:
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --filter pandoc-citeproc \  | ::: {#cb58 .sourceCode}           |
|                                 | ``` {.sourceCode .yaml}           |
|  --lua-filter count-words.lua \ | filters:                          |
|      --filter special.lua       |   - pandoc-citeproc               |
|                                 |   - count-words.lua               |
|                                 |   - type: json                    |
|                                 |     path: special.lua             |
|                                 | ```                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --number-sections           | ::: {#cb132 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | number-sections: true             |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --number-offset=1,4         | ::: {#cb134 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | number-offset: \[1,4\]            |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --listings                  | ::: {#cb136 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | listings: true                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --incremental               | ::: {#cb138 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | incremental: true                 |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --slide-level 2             | ::: {#cb140 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | slide-level: 2                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --section-divs              | ::: {#cb142 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | section-divs: true                |
|                                 | ```                               |
|                                 | :::                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --id-prefix ch1             | ::: {#cb146 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | identifier-prefix: ch1            |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --title-prefix MySite       | ::: {#cb148 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | title-prefix: MySite              |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --css styles/screen.css  \  | ::: {#cb150 .sourceCode}          |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --reference-doc my.docx     | ::: {#cb152 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --epub-metadata meta.xml    | ::: {#cb156 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | epub-metadata: meta.xml           |
|                                 | ```                               |
|                                 | :::                               |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --epub-chapter-level 2      | ::: {#cb160 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | epub-chapter-level: 2             |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --epub-subdirectory=""      | ::: {#cb162 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | epub-subdirectory: ''             |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --ipynb-output best         | ::: {#cb164 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | ipynb-output: best                |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --pdf-engine xelatex        | ::: {#cb166 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | pdf-engine: xelatex               |
|                                 | ```                               |
|                                 | :::                               |
...
| command line                    | defaults file                     |
+:================================+:==================================+
|     --citeproc                  | ::: {#cb171 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | citeproc: true                    |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --bibliography logic.bib    | ::: {#cb173 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | metadata:                         |
...
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --natbib                    | ::: {#cb179 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | cite-method: natbib               |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --biblatex                  | ::: {#cb181 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
...
| command line                    | defaults file                     |
+:================================+:==================================+
|     --dump-args                 | ::: {#cb193 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | dump-args: true                   |
|                                 | ```                               |
|                                 | :::                               |
+---------------------------------+-----------------------------------+
|     --ignore-args               | ::: {#cb195 .sourceCode}          |
|                                 | ``` {.sourceCode .yaml}           |
|                                 | ignore-args: true                 |
|                                 | ```                               |
|                                 | :::                               |
...
`abstract-title`
:   title of abstract, currently used only in HTML and EPUB. This will
    be set automatically to a localized value, depending on `lang`, but
...
rendering](#citation-rendering-1).
...
:   The way math is rendered in HTML will depend on the command-line
    ...
    HTML](#math-rendering-in-html-1) above.
...
`background-image` to produce a parallax scrolling background. You must
also set `parallaxBackgroundSize`, and can optionally set
`parallaxBackgroundHorizontal` and `parallaxBackgroundVertical` to
configure the scrolling behaviour. See the [reveal.js
